                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="profilePicture  " type="file" class="form-control @error('contactNo') is-invalid @enderror" name="profilePicture" value="{{ old('profilePicture') }}" required autocomplete="profilePicture" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('  Resume    ') }}</label>
                            <div class="col-md-6">
